...
https://github.com/chainer/chainercv/master/chainercv/links/model/faster_rcnn/utils/proposal_creator.py
modified to adapt multi level features produced by Feature Pyramid Network.
"""
import numpy as np
...
class ProposalCreator(object):
    ...
    def __call__(self, loc, score,
                 anchor, level_indices, img_size, scale=1.):
        """Propose RoIs.
        ...
        Args:
            ...
            anchor (array): Coordinates of anchors. Its shape is
                :math:`(R, 4)`.
            level_indices (array): level index which indicate where this anchor comes from in feature levels proposed by FPN. Its shape is
                :math:`(R,)`.
